...
#define SAVE_ADDR 0x8BFFFF00
#define SAVEPATH (char*)SAVE_ADDR
#define GAMEID_ADDR (SAVE_ADDR+SAVE_PATH_SIZE)
#define GAMEID (char*)GAMEID_ADDR
#define NEWER_FIRMWARE *(char*)(GAMEID_ADDR+9)
